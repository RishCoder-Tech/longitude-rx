...
export default function AboutPage() {
  ...
  const leadershipTeam = [
    ...
    },
    {
      ...
      bio: "Shilpa Patel serves as Director of Product and Innovation at Longitude Rx, where she leads the development and implementation of innovative product strategies that enhance patient care and operational efficiency across specialty pharmacy services. With her extensive background in healthcare technology and product management, Shilpa drives the company's digital transformation initiatives and oversees the creation of cutting-edge solutions that improve medication access and patient outcomes.\n\nShilpa brings a unique combination of technical expertise and strategic vision to her role, focusing on leveraging emerging technologies to solve complex healthcare challenges. She is passionate about creating user-centered products that streamline workflows for healthcare providers while ensuring optimal patient experiences. Her leadership in product innovation has been instrumental in developing scalable solutions that support Longitude Rx's mission of transforming specialty pharmacy operations.\n\nPrior to joining Longitude Rx, Shilpa held senior product management roles at leading healthcare technology companies, where she successfully launched multiple digital health platforms and led cross-functional teams in delivering innovative solutions. She has a proven track record of translating complex healthcare requirements into intuitive, effective products that drive measurable improvements in both clinical and operational outcomes.\n\nShilpa holds advanced degrees in healthcare management and technology, and she is committed to advancing the field of specialty pharmacy through continuous innovation and strategic product development.",
      linkedin: "https://www.linkedin.com/in/shilpa-patel/",
    },
  ]
