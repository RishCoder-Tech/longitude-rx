  ...
  const leadershipTeam = [
    {
      ...
      headshot: "/Jigar 2.png",
      bio: `Jigar Thakkar, Pharm D, MBA, MHCDS, FACHE is the Founder and CEO of Longitude Rx. In this role, he is building the infrastructure, technology, and partnerships that help health systems deliver more coordinated, accessible specialty pharmacy care, including emerging therapies in rare disease, cell, and gene therapies.\n\nJigar brings deep expertise in academic health systems and integrated delivery networks, with a career defined by turning complex, fragmented operations into high-performing businesses. At OU Health, he built the specialty pharmacy program from zero to over $470M in annual revenue within four years — the result of sharp clinical strategy, operational discipline, and enterprise-level leadership. He later served as the system's Chief Administrative Officer, overseeing a broad portfolio spanning cancer services, radiology, lab, and major strategic partnerships.\n\nPrior to OU Health, Jigar served as a Managing Director at FTI Consulting, a global advisory firm where he worked with health system executives, Fortune 100 companies, and private equity firms on pharmacy strategy, growth initiatives, and performance improvement across the industry.\n\nJigar holds a Pharm D from Midwestern University, an MBA from Northwestern University's Kellogg School of Management, and a Master of Health Care Delivery Science from Dartmouth College. He is a Fellow of the American College of Healthcare Executives and serves on the hospital advisory board of Cencora.`,
      linkedin: "https://www.linkedin.com/in/jigar24/",
    },
    {
      name: "Stacy Walton",
      title: "Chief Commercial Officer",
      headshot: "/Stacy Walton.jpeg",
      bio: "As the Chief Commercial Officer of Longitude Rx, Stacy Walton leads market access, payer and manufacturer engagement, and health system growth, expanding Longitude Rx's reach to new health system partners and broadening drug and payer access for more patients.\n\nStacy began her career as a critical care nurse. Over the next three decades, she built an executive track record at the intersection of clinical operations and commercial strategy in specialty pharmacy. Most recently, as Senior Vice President of Trade Relations at a national firm specializing in hospital-owned specialty pharmacy solutions and supporting more than 80 health systems, she generated more than $3B in limited distribution drug revenue and oversaw 200+ biopharma partnerships.\n\nEarlier in her career at OptumRx, she led national clinical programs across oncology, immunology, neurology, and rare disease, and oversaw contract negotiations and limited distribution drug network access as Senior Director.\n\nStacy holds a Bachelor of Science in Nursing from American Sentinel University and a nursing degree from Samford University. She serves on the Pulmonary Hypertension Association's Specialty Advisory Board and Corporate Committee.",
    },
    {
    ...
    {
      name: "Kyle Asay",
      title: "Vice President of Strategic Initiatives & PMO",
      headshot: "/Kyle Asay.jpg",
      bio: "Kyle Asay is a healthcare strategy and operations leader with over 10 years of experience across leading academic health systems and early-stage health tech organizations. At Longitude Rx, he manages the implementation of key initiatives that drive operational performance and growth within health systems, partnering closely with clinical, pharmacy, and executive leadership teams to execute complex, multi-system strategies.\n\nKyle also brings experience in corporate and venture-oriented finance, supporting pro forma development, capital planning, partnership structuring, and investment analysis for new service lines and emerging healthcare ventures.\n\nEarlier in his career, he held strategy and operational roles within prominent academic medical centers including Stanford Health Care, UCLA Health, VCU Health, and the University of Utah Health, where he focused on service line expansion, enterprise strategic initiatives, and pharmacy operations.\n\nKyle holds a finance degree from the University of Utah and a Master of Health Administration from Virginia Commonwealth University. He completed an Administrative Fellowship at Stanford Health Care.",
    },
  ]
