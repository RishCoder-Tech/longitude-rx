    ...
    <div className="flex flex-col min-h-screen pt-24">
                          ...
                          {job.fields.requirements && job.fields.requirements.length > 0 && (
                            <div className="mb-4">
                              ...
                              <ul className="space-y-1">
                                {job.fields.requirements.slice(0, 3).map((req, idx) => (
                                ...
                                {job.fields.requirements.length > 3 && (
                                  <li className="text-admiral-500 text-xs">
                                    +{job.fields.requirements.length - 3} more requirements
                                  </li>
                                )}
                              </ul>
                            </div>
      ...
      {selectedJob && (
        <JobApplicationForm
          ...
          jobTitle={selectedJob.fields.title}
